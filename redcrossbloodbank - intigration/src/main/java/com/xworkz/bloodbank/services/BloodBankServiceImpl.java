...
public class BloodBankServiceImpl implements BloodBankServices {
    ...
    public BloodBankDto validateAndSearchGmail(String gmail) {
        if (gmail != null) {
            ...
            RedCrossBloodEntity entity = bloodBankDao.SearchEmail(gmail);
            if (entity != null) {
        ...
        @Override
        public boolean validateAndSaveDonors (BloodBankDto bloodBankDto){
            RedCrossBloodEntity redCrossBloodEntity = new RedCrossBloodEntity();
            if (bloodBankDto != null) {
                BeanUtils.copyProperties(bloodBankDto, redCrossBloodEntity);
                return bloodBankDao.saveDonor(redCrossBloodEntity);
    ...
    @Override
    public BloodBankDto validateAndSearchById(String id) {

        if (id!=null){
            bloodBankDao.searchByID(id);
        }
