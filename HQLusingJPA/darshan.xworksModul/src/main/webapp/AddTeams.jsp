...
<head>
    ...
    <style>
        .team-card {
            max-width: 420px;   /* reduces card size */
            border-radius: 14px;
        }
...
<div class="container text-center my-5">
      ...
      <div class="card team-card shadow-sm">
          <div class="card-header bg-primary text-white text-center">
              ...
              <small class="text-light">Team Details</small>
          </div>
...
<form action="addTeam" method="post" id="teamForm" onsubmit="return validateTeamForm()">
    ...
    <div class="row mb-2 align-items-center">
        ...
        <div class="col-8">
            ...
            <small class="text-danger" id="teamNameError"></small>
        </div>
    </div>

    <!-- Team Head -->
    <div class="row mb-2 align-items-center">
        <label class="col-4 col-form-label">Team Head</label>
        <div class="col-8">
            <input type="text" id="teamHead" name="teamHead"
                   class="form-control form-control-sm"
                   onblur="validateTeamHead()">
            <small class="text-danger" id="teamHeadError"></small>
        </div>
    </div>
...
function validateTeamHead() {
    let head = document.getElementById("teamHead").value.trim();

    if (head.length < 3) {
        document.getElementById("teamHeadError").innerText =
            "Team Head must be at least 3 characters";
        return false;
    }
